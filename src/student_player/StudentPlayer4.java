...
public class StudentPlayer4 extends BohnenspielPlayer {
	...
	private BohnenspielMove getFirstMoveAB(BohnenspielBoardState boardState) {
		// TODO improve
		AlphaBetaMinimax abmm = new AlphaBetaMinimax(boardState.getTurnPlayer(), "scoreAndBeanDifferenceWithBeansLeft");
